...
const StatsNav = () => {
  ...
  return (
    <div className="w-full flex justify-between px-3 py-5 md:px-10 md:py-6 items-center gap-3 bg-[#ededed] rounded-xl">
      <div>
        <img src={logo} alt="logo" className="w-[120px] h-[30px] md:w-full" />
      </div>
      <div className="flex justify-start gap-3 md:gap-5">
        <button className=" px-4 py-2 md:px-4 md:py-3 bg-transparent border-[1px] border-[#b0cc81] rounded-full text-[#181617] cursor-pointer">
          <IoShareSocialSharp />
        </button>
        <button className="w-auto px-3 py-2 md:px-5 md:py-3 bg-transparent border-[1px] border-[#1e43b5] rounded-full text-[#181617] cursor-pointer">
        ...
        <div className="relative">
          <div className="flex items-center">
            <div className="btn btn-ghost" onClick={toggleMenu}>
              <FaBars className="text-[#181617] text-2xl" />
            </div>
          </div>
          {/* top-[-20px] */}
          {menuOpen && (
